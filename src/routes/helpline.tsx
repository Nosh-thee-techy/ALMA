    ...
    <AppShell>
      <header className="mb-6">
        ...
        <p className="mt-2 max-w-2xl text-sm text-muted-foreground">
          Pick a ward on the heat map, then play the voice agent breakdown. Farmers without data use the phone
          menu or USSD <strong className="text-foreground">*384*96428#</strong>.
        </p>
      </header>
